...
//        echo '<div class="post-meta wf-mobile-collapsed">
//Автор: <a class="author vcard psy-author" rel="author" href="/team/'.$author->post_name.'">'.$author->post_title.'</a></div>';
//    }



    echo '<strong>Понравилась статья? Поделиться:</strong>';
    echo do_shortcode( '[SvenSoftSocialShareButtons]' );
