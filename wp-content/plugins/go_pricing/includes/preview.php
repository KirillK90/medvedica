 ...
 */  
ob_start(); 
$gopr_absolute_path = __FILE__;
$gopr_path_to_file = explode( 'wp-content', $gopr_absolute_path );
$gopr_path_to_wp = $gopr_path_to_file[0];
include_once( $gopr_path_to_wp . '/wp-load.php' );
