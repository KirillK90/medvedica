...
<tr class="gwa-row-fullwidth">
	...
	<div class="gwa-icon-picker">
		<div class="gwa-icon-picker-header">
			...
			<div class="gwa-icon-picker-search">
				...
				<select data-action="ip-filter" class="gwa-w120 gwa-ml10">                                
                    ...
                    <option value="4.6">4.6 (36)</option>
                    <option value="4.7">4.7 (55)</option>																																	
			    </select>
			</div>			
		</div>
		<div class="gwa-icon-picker-content gwa-clearfix">
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-address-book" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-address-book-o" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-address-card" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-address-card-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-american-sign-language-interpreting" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-asl-interpreting" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-assistive-listening-systems" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-audio-description" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-bandcamp" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-bath" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-bathtub" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-battery" data-filter="4.4"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-blind" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-braille" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-deaf" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-deafness" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-drivers-license" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-drivers-license-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-eercast" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-envelope-open" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-envelope-open-o" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-envelope-square" data-filter="4.1"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-envira" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-eraser"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-etsy" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-fa" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-first-order" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-font-awesome" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-free-code-camp" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-gitlab" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-glide" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-glide-g" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-google-plus-circle" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-google-plus-official" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-grav" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-handshake-o" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-hard-of-hearing" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-id-badge" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-id-card" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-id-card-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-imdb" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-instagram" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-linode" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-low-vision" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-meetup" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-microchip" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-pied-piper" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-pied-piper-alt" data-filter="4.1"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-pied-piper-pp" data-filter="4.1"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-podcast" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-question-circle-o" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-quora" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-ravelry" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-resistance" data-filter="4.1"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-s15" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-shower" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-sign-in"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-sign-language" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-signing" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-snapchat" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-snapchat-ghost" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-snapchat-square" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-snowflake-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-superpowers" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-telegram" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-themeisle" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-0" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-1" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-2" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-3" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-4" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-empty" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-full" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-half" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-quarter" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-thermometer-three-quarters" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-times-rectangle" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-times-rectangle-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-universal-access" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-user-circle" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-user-circle-o" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-user-md"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-user-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-vcard" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-vcard-o" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-viadeo" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-viadeo-square" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-volume-control-phone" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-wheelchair-alt" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-window-close" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-window-close-o" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-window-maximize" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-window-minimize" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-window-restore" data-filter="4.7"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-wpbeginner" data-filter="4.6"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-wpexplorer" data-filter="4.7"></i></a>
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-wpforms" data-filter="4.6"></i></a>
            ...
            <a href="#" class="gwa-icon-picker-icon" data-action="ip-select" tabindex="0"><i class="fa fa-yoast" data-filter="4.6"></i></a>
