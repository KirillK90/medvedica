					...
					<div class="gwa-abox-content gwa-abox-tab-content">				
						<table class="gwa-table">
                            ...
                            <tr class="gwa-row-fullwidth">
                                <td><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Animation engine is disabled! Please turn off the "Disable Loading TweenMax" option under "Public Assets" tab on "General Settings" page.', 'go_pricing_textdomain' ); ?></p></td>
                            </tr>
							<?php
							endif;
							?>
