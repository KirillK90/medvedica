...
if(!function_exists('ult_price_generate_design06')) {
	function ult_price_generate_design06($atts,$content = null){
		...
		$output .= '<div class="ult_pricing_table_wrap ult_design_6 '.esc_attr($featured).' ult-cs-'.esc_attr($color_scheme).' '.esc_attr($el_class).' '.esc_attr($css_price_box).'">
					<div class="ult_pricing_table '.esc_attr($ult_price_table_ht).'" style="'.esc_attr($normal_style).' '.esc_attr($price_normal_style).'">';
