...
if(!function_exists('ult_info_table_generate_design03')) {
	function ult_info_table_generate_design03($atts,$content = null){
		...
		$output .= '<div class="ult_pricing_table_wrap ult_info_table ult_design_3 '.esc_attr($featured).' ult-cs-'.esc_attr($color_scheme).' '.esc_attr($el_class).''.esc_attr($css_info_tables).'">
