...
<div class="wrap about-wrap bsf-page-wrapper ultimate-about bend">
  <div class="wrap-container">
    <div class="bend-heading-section ultimate-header">
      <h1><?php _e( "Ultimate Addons for Visual Composer", "ultimate_vc" ); ?></h1>
      <h3><?php _e( "Welcome! You are about to begin with the most powerful addon for Visual Composer that add in many advanced features developed with love at Brainstorm Force.", "ultimate_vc" ); ?></h3>
					...
					<div class="col-sm-6 col-lg-6">
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								<h4 class="ult-addon-heading"><?php echo __('What is the Ultimate Addons for Visual Composer?','ultimate_vc'); ?></h4>
								<p class="ult-addon-discription"><?php echo __('The Ultimate Addons for Visual Composer is developed to extend Visual Composer to save your time in building websites. This plugin adds a number of elements to the basic set of elements that come with the page builder. All these elements are added to your Visual Composer editor and can be used just like any other built-in features.','ultimate_vc'); ?></p>
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								...
								<p class="ult-addon-discription"><?php echo __('Go ahead and explore the Ultimate elements of the Ultimate Addons for Visual Composer!','ultimate_vc'); ?></p>
							</div><!--bsf-wrap-right-content-->
						</div><!--bsf wrap content-->
				    ...
				    <div class="col-sm-6 col-lg-6">
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								...
								<p class="ult-addon-discription"><?php echo __('With the Ultimate Addons, you are free to use the basic elements of Visual Composer with','ultimate_vc'); ?> <a target="_blank" href="https://cloudup.com/ce1eKqH_PDp"><?php echo __('several advanced elements','ultimate_vc'); ?></a> <?php echo __('that it adds in the editor.','ultimate_vc'); ?></p>
							</div><!--bsf-wrap-right-content-->
						</div><!--bsf wrap content-->
