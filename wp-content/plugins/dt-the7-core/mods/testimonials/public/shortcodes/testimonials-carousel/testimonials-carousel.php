...
if ( ! class_exists( 'DT_Shortcode_Testimonials_Carousel', false ) ) :
	...
	class DT_Shortcode_Testimonials_Carousel extends DT_Shortcode_With_Inline_Css {
		...
		protected function do_shortcode( $atts, $content = '' ) {
			...
			echo '<div ' . $this->get_container_html_class( array( 'owl-carousel testimonials-carousel-shortcode dt-testimonials-shortcode' ) ) . ' ' . $this->get_container_data_atts() . '>';
		...
		protected function get_less_file_name() {
			...
			$less_file_name = 'dt-testimonials-carousel';
