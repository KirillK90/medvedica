...
if ( ! class_exists( 'DT_Shortcode_Portfolio_Carousel', false ) ) :

	class DT_Shortcode_Portfolio_Carousel extends DT_Shortcode_With_Inline_Css {
		/**
		 * @var string
		 */
		protected $post_type;
		...
		/**
		 * @var DT_Portfolio_Shortcode_Carousel
		 */
		public static $instance = null;

		/**
		 * @return DT_Portfolio_Shortcode_Carousel
		 */
		...
		public function __construct() {
			...
			$this->sc_name = 'dt_portfolio_carousel';
			$this->unique_class_base = 'portfolio-carousel-shortcode-id';
		...
		protected function do_shortcode( $atts, $content = '' ) {
			...
			echo '<div ' . $this->get_container_html_class( array( 'owl-carousel portfolio-carousel-shortcode portfolio-shortcode' ) ) . ' ' . $this->get_container_data_atts() . '>';
		...
		protected function get_less_vars() {
			...
			$less_vars->add_keyword( 'unique-shortcode-class-name', 'portfolio-carousel-shortcode.' . $this->get_unique_class(), '~"%s"' );
		...
		protected function get_less_file_name() {
			...
			$less_file_name = 'dt-portfolio-carousel';
		...
		protected function get_vc_inline_html() {
			...
			return $this->vc_inline_dummy( array(
				'class'  => 'dt_vc-portfolio_carousel',
				'img' => array( PRESSCORE_SHORTCODES_URI . '/images/vc_blog_carousel_editor_ico.gif', 131, 104 ),
				'title'  => _x( 'Portfolio Carousel', 'vc inline dummy', 'the7mk2' ),
	...
	// create shortcode
	DT_Shortcode_Portfolio_Carousel::get_instance()->add_shortcode();
endif;
